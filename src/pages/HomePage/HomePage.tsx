...
import "./HomePage.css"; // Renamed CSS import
...
const HomePage: React.FC = () => {
  ...
  const createNewDocument = () => {
    const newDoc: Document = {
      ...
      lastEdited: "Just now",
      image:
        "https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzcGFjZXN8Mnx8dHJhdmVsfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60",
    };
    ...
    <div className="app">
      ...
      <main className="main-content">
        <section className="new-document-section">
          <Link to="/new-trip" className="new-document-card">
            {" "}
            {/* Use Link here */}
